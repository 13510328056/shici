    ...
    <div className="px-4 pt-4 pb-2">
      ...
      <div className="mb-5">
        ...
        <div className="flex gap-3 overflow-x-auto no-scrollbar">
          {[
            { label: '五言诗', sub: '五绝 · 五律', genre: '五绝', color: 'from-[#4A6670]/20 to-transparent', border: 'border-[#4A6670]/30' },
            { label: '七言诗', sub: '七绝 · 七律', genre: '七绝', color: 'from-[#C23B22]/10 to-transparent', border: 'border-[#C23B22]/20' },
            { label: '词 · 长短句', sub: '婉约 · 豪放', genre: '词', color: 'from-[#B8860B]/10 to-transparent', border: 'border-[#B8860B]/20' },
          ].map((item, i) => (
            <div key={i}
              ...
              style={{ outline: '1px solid #ede8e0', outlineOffset: 1 }}
              onClick={() => navigate(`/search?genre=${item.genre}`)}>
